...
const GridCard = ({item}) => {
  ...
  return (
    <>
      <div onClick={()=>{navigate(`/editor/${item._id}`)}} className="gridCard bg-[#141414] w-[270px] p-[10px] h-[140px] cursor-pointer hover:bg-[#202020] rounded-lg shadow-lg shadow-black/50">
       <div >
